	...
	<div class="container">
		...
		<div class="tabarea">
            <nav>
                ...
                <a href='#' class="tab2" onclick="displayQuestions('current', 'answers', event);">Most Answers</a>
                <a href='#' class="tab2" onclick="displayQuestions('current', 'views', event);">Most Views</a>
            </nav>
        </div>
